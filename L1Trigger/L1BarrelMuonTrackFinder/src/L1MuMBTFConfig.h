 ...
 *
 *   Configuration parameters for L1MuMBTrackFinder
 *
 *
 *
...
//
//--------------------------------------------------
#ifndef L1MUMB_TF_CONFIG_H
#define L1MUMB_TF_CONFIG_H
...
class L1MuMBTFConfig {
  ...
  public:
    ...
    /// constructor
    L1MuMBTFConfig(const edm::ParameterSet & ps); 
     
    /// destructor 
    virtual ~L1MuMBTFConfig();

    static edm::InputTag getMBDigiInputTag() { return m_MBDigiInputTag; }
  ...
  private:
    ...
    static edm::InputTag m_MBDigiInputTag;
