...
L1MuMBTrackSegLoc::L1MuMBTrackSegLoc() :
  m_wheel(0), m_sector(0), m_station(0) {}

L1MuMBTrackSegLoc::L1MuMBTrackSegLoc(int wheel_id,
                                     int sector_id,
                                     int station_id) :
...
L1MuMBTrackSegLoc::L1MuMBTrackSegLoc(const L1MuMBTrackSegLoc &id) :
...
// Assignment operator
//
L1MuMBTrackSegLoc& L1MuMBTrackSegLoc::operator=(const L1MuMBTrackSegLoc& id) {
...
// Equal operator
//
bool L1MuMBTrackSegLoc::operator==(const L1MuMBTrackSegLoc& id) const {
...
//
ostream& operator<<(ostream& s, const L1MuMBTrackSegLoc& id) {
