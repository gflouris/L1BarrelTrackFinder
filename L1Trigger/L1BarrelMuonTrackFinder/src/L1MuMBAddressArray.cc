...
L1MuMBAddressArray::L1MuMBAddressArray() {
...
L1MuMBAddressArray::L1MuMBAddressArray(const L1MuMBAddressArray& addarray) {
...
// assignment operator
//
L1MuMBAddressArray& L1MuMBAddressArray::operator=(const L1MuMBAddressArray& addarray) {
...
//
//
bool L1MuMBAddressArray::operator==(const L1MuMBAddressArray& addarray) const {
...
//
void L1MuMBAddressArray::setStation(int stat, int adr) {
...
//
void L1MuMBAddressArray::setStations(int adr1, int adr2, int adr3, int adr4) {
...
//
int L1MuMBAddressArray::trackAddressCode() const {
...
//
L1MuMBAddressArray L1MuMBAddressArray::converted() const {

  unsigned short int adr1 = L1MuMBAddressArray::convert(m_station[0]);
  unsigned short int adr2 = L1MuMBAddressArray::convert(m_station[1]);
  unsigned short int adr3 = L1MuMBAddressArray::convert(m_station[2]);
  unsigned short int adr4 = L1MuMBAddressArray::convert(m_station[3]);

  L1MuMBAddressArray newaddressarray;
...
//
//
ostream& operator<<(ostream& s, const L1MuMBAddressArray& adrarr ) {
...
//
unsigned short int L1MuMBAddressArray::convert(unsigned short int adr) {
...
//
bool L1MuMBAddressArray::sameWheel(unsigned short int adr) {

  //  if ( adr > 15 ) cerr << "L1MuMBAddressArray : Error wrong address " << adr << endl;
  return ( (adr/2)%2 == 0 );
...
//
bool L1MuMBAddressArray::nextWheel(unsigned short int adr) {
