...
L1MuMBTrackAssembler::L1MuMBTrackAssembler(const L1MuMBSectorProcessor& sp) :
         m_sp(sp) {
...
L1MuMBTrackAssembler::~L1MuMBTrackAssembler() {
...
void L1MuMBTrackAssembler::run() {
  ...
  if ( ( s2_2 == 15 && s3_2 == 15 && s4_2 == 15 ) ||
    ...
    if ( L1MuMBTFConfig::Debug(5) ) cout << "L1MuMBTrackAssembler: second track has been cancelled" << endl;
    if ( L1MuMBTFConfig::Debug(5) ) print();
...
//
void L1MuMBTrackAssembler::reset() {
...
//
void L1MuMBTrackAssembler::print() const {
...
//
void L1MuMBTrackAssembler::runEncoderSubUnit1(unsigned& global, unsigned& group, unsigned& priority) {
...
//
void L1MuMBTrackAssembler::runEncoderSubUnit2(unsigned& global, unsigned& group, unsigned& priority) {
...
//
void L1MuMBTrackAssembler::runAddressAssignment1(int global, int group) {
...
//
void L1MuMBTrackAssembler::runAddressAssignment2(int global, int group) {
...
//
unsigned int L1MuMBTrackAssembler::priorityEncoder12(const bitset<12>& input)  {
...
//
unsigned int L1MuMBTrackAssembler::priorityEncoder4(const bitset<4>& input)  {
...
//
unsigned int L1MuMBTrackAssembler::priorityEncoder22(const bitset<22>& input)  {
...
//
unsigned int L1MuMBTrackAssembler::priorityEncoder21(const bitset<21>& input)  {
...
//
unsigned int L1MuMBTrackAssembler::addressEncoder12(const bitset<12>& input)  {
...
//
unsigned int L1MuMBTrackAssembler::addressEncoder12s(const bitset<12>& input)  {
...
//
unsigned long L1MuMBTrackAssembler::subBitset68(const bitset<68>& input, int pos, int length) {
...
//
unsigned long L1MuMBTrackAssembler::subBitset56(const bitset<56>& input, int pos, int length) {
...
// Cancel Out Table
//
bitset<56> L1MuMBTrackAssembler::getCancelationTable(unsigned int p) {
