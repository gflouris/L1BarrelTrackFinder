...
//
//   Description: MBTrackFinder parameters for L1MuMBTrackFinder
//
//
//
//   Author :
...
L1MuMBTFConfig::L1MuMBTFConfig(const edm::ParameterSet & ps) {
...
void L1MuMBTFConfig::setDefaults() {

  m_MBDigiInputTag = m_ps->getParameter<edm::InputTag>("DTDigi_Source");
  ...
  if ( Debug(1) ) cout << "L1 barrel Track Finder : MB Digi Source:  " <<  m_MBDigiInputTag << endl;
...
edm::InputTag L1MuMBTFConfig::m_MBDigiInputTag = edm::InputTag();
edm::InputTag L1MuMBTFConfig::m_CSCTrSInputTag = edm::InputTag();

bool L1MuMBTFConfig::m_debug = false;
int  L1MuMBTFConfig::m_dbgLevel = -1;
bool L1MuMBTFConfig::m_overlap = true;
int  L1MuMBTFConfig::m_BxMin = -9;
int  L1MuMBTFConfig::m_BxMax =  7;
int  L1MuMBTFConfig::m_extTSFilter  = 1;
bool L1MuMBTFConfig::m_openLUTs  = false;
bool L1MuMBTFConfig::m_useEX21 = false;
bool L1MuMBTFConfig::m_etaTF = true;
bool L1MuMBTFConfig::m_etacanc = false;
bool L1MuMBTFConfig::m_TSOutOfTimeFilter = false;
int  L1MuMBTFConfig::m_TSOutOfTimeWindow = 1;
int  L1MuMBTFConfig::m_NbitsExtPhi  = 8;
int  L1MuMBTFConfig::m_NbitsExtPhib = 8;
int  L1MuMBTFConfig::m_NbitsPtaPhi  = 12;
int  L1MuMBTFConfig::m_NbitsPtaPhib = 10;
int  L1MuMBTFConfig::m_NbitsPhiPhi  = 10;
int  L1MuMBTFConfig::m_NbitsPhiPhib = 10;
