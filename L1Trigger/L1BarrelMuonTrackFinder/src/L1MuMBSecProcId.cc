...
L1MuMBSecProcId::L1MuMBSecProcId() :
      m_wheel(0), m_sector(0) {}

L1MuMBSecProcId::L1MuMBSecProcId(int wheel_id, int sector_id) :
...
L1MuMBSecProcId::L1MuMBSecProcId(const L1MuMBSecProcId& id) :
...
// Assignment operator
//
L1MuMBSecProcId& L1MuMBSecProcId::operator=(const L1MuMBSecProcId& id) {
...
//
int L1MuMBSecProcId::locwheel() const {
...
// Equal operator
//
bool L1MuMBSecProcId::operator==(const L1MuMBSecProcId& id) const {
...
//
ostream& operator<<(ostream& s, const L1MuMBSecProcId& id) {
