...
//
//--------------------------------------------------
#ifndef L1MUMB_TRACK_ASSEMBLER_H
#define L1MUMB_TRACK_ASSEMBLER_H
...
class L1MuMBTrackAssembler : public L1AbstractProcessor {

  public:

    /// constructor
    L1MuMBTrackAssembler(const L1MuMBSectorProcessor& );

    /// destructor
    virtual ~L1MuMBTrackAssembler();
    ...
    inline L1MuMBAddressArray address(int id) const { return m_theAddresses[id]; }
  ...
  private:
    ...
    L1MuMBAddressArray           m_theAddresses[2];  // relative addresses of the 2 candidates
